---
description: Il servizio Experience Cloud ID sostituisce i metodi legacy di raccolta degli ID visitatore Analytics.
keywords: Servizio ID
seo-description: Il servizio Experience Cloud ID sostituisce i metodi legacy di raccolta degli ID visitatore Analytics.
...
Il servizio Experience Cloud ID sostituisce i metodi legacy di raccolta degli ID visitatore Analytics.
...
In alcuni casi, però, l&#39;impostazione del cookie nell&#39;intestazione HTTP è da preferire per il monitoraggio tra domini diversi. Questo metodo è descritto in [CNAME per raccolta dati e monitoraggio tra più domini](../../mcvid-reference/mcvid-analytics-reference/mcvid-cname.md#concept-4df91f8a30ad4ec7a01eb943d579cc9d).
...
<table id="table_D267D36451F643D1BB68AF6FEAA6AD1A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Il visitatore aveva un altro cookie s_vi prima dell'implementazione del servizio <span class="keyword">Experience Cloud</span> ID, oppure è stato configurato un.<a href="../../mcvid-reference/mcvid-analytics-reference/mcvid-grace-period.md" format="dita" scope="local">periodo di tolleranza</a>. </p> </td> 
  </tr> 
  <tr> 
...
>[!MORE_LIKE_THIS]
>
>* [Ordine delle operazioni per gli ID di Analytics](../../mcvid-reference/mcvid-analytics-reference/mcvid-analytics-order-of-operations.md#concept-b92935b4fff545adb4773f3728bc15ef)
