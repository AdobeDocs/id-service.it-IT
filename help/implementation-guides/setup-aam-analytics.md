...
title: Implementazione del servizio ID visitatore di Adobe per Analytics e Audience Manager
...
# Implementazione del servizio ID visitatore di Adobe per Analytics e Audience Manager{#implement-the-experience-cloud-id-service-for-analytics-and-audience-manager}
...
## Passaggio 9: verifica e distribuisci il codice del servizio ID visitatore {#section-f857542bfc70496dbb9f318d6b3ae110}

Puoi eseguire il test e distribuirlo come segue.

**Test e verifica**

Per verificare l’implementazione del servizio ID visitatori, controlla i seguenti elementi:
...
* Vedi anche [Test e verifica del servizio ID visitatori](../implementation-guides/test-verify.md).
