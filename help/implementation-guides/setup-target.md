...
Il [!UICONTROL servizio ID] richiede la libreria dei codici `VisitorAPI.js`. Per ottenere questo codice, contatta l’ [Assistenza](https://helpx.adobe.com/it/marketing-cloud/contact-support.html) clienti.
...
* Controllate il cookie AMCV nel dominio di hosting della pagina.
