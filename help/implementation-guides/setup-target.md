---
description: Queste istruzioni sono per chi utilizza Target e desidera usare il servizio Experience Cloud Identity e non usa i tag di Raccolta dati. Tuttavia, si consiglia vivamente di usare i tag per implementare il servizio ID. I tag agevolano il flusso di lavoro di implementazione e assicurano automaticamente il posizionamento e la sequenza del codice corretti.
