---
description: Questi esempi coprono 2 casi d'uso comuni relativi a un'integrazione diretta e all'Experience Cloud ID (MID). Il MID è un ID univoco e costante per i visitatori del sito.
keywords: ID Service
seo-description: Questi esempi coprono 2 casi d'uso comuni relativi a un'integrazione diretta e all'Experience Cloud ID (MID). Il MID è un ID univoco e costante per i visitatori del sito.
...
<table id="table_DA8840FCB51541109FE6DF20430E8924"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Questo caso d’uso presuppone che: </p> 
    <ul id="ul_F20231F83EE84889B78971A64E758757"> 
     ...
     <li id="li_4611146E56624C2AB647733487A3F046"> <i>(Facoltativo)</i> Desidera impostare uno stato di autenticazione per il visitatore. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Azioni</b> </p> </td> 
   <td colname="col2"> <p>Considerate queste condizioni, effettua una chiamata al servizio ID che include: </p> 
    <ul id="ul_9ECB1A65266644E89E949C57D202D5A4"> 
     ...
     <li id="li_3D1556AD18C843828A362CC604A9F76B"> <i>(Facoltativo)</i> Un ID di stato per definire lo stato di autenticazione del visitatore. </li> 
    </ul> <p>Nel caso in cui tu disponga degli altri parametri elencati in <a href="../implementation-guides/direct-integration.md#concept-4cd3206a84bb4687af0b312ae09648b9" format="dita" scope="local">guida all'integrazione diretta</a> (es., <span class="codeph">d_blob</span> o <span class="codeph">dcs_region</span>, ecc.) e' bene trasmettere anche quelli. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Soluzione ed esempio di codice</b> </p> </td> 
   <td colname="col2"> <p>Formatta la tua chiamata al servizio ID nel modo seguente: </p> <p> <span class="codeph">https://dpm.demdex.net/id?d_mid=1234&amp;d_cid=4444%019876%011&amp;d_ver=2</span> </p> <p>Nota che la chiamata di esempio contiene: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Questo caso d’uso presuppone che: </p> 
    <ul id="ul_BF3BD821907B46A4B2EFA63146D35722"> 
     ...
     <li id="li_28A48BB3F71C4E4297F95A2D3E10AD7B">Devi richiedere un MID dal servizio ID. </li> 
