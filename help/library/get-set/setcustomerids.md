...
Puoi impostare uno o più ID, come mostrato nel seguente codice di esempio. See [Customer IDs and Authentication States](../../reference/authenticated-state.md) for more information and examples.
