---
description: getCustomerIDs restituisce tutti gli ID cliente impostati dal servizio ID visitatore.
...
getCustomerIDs restituisce tutti gli ID cliente impostati dal servizio ID visitatore.
