---
description: Le funzioni idSyncByURL e idSyncByDataSource del servizio ID visitatore consentono di implementare manualmente una sincronizzazione ID nel Destination Publishing iFrame. Sono disponibili in VisitorAPI.js versione 1.10 o successiva.
...
Le funzioni idSyncByURL e idSyncByDataSource del servizio ID visitatore consentono di implementare manualmente una sincronizzazione ID nel Destination Publishing iFrame. Sono disponibili in `VisitorAPI.js` versioni 1.10 o successive.
...
>[!MORELIKETHIS]
>
>* [DIL idSync](https://experienceleague.adobe.com/docs/audience-manager/user-guide/dil-api/dil-instance-methods.html?lang=it#idsync)
