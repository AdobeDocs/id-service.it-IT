...
Se si utilizzano i tag, aggiornare l&#39;estensione tag [!UICONTROL Experience Cloud ID Service] alla versione 5.1.0 e configurare `secureCookie: true` e `sameSiteCookie: none`.

Se non utilizzi i tag, esegui l’aggiornamento alla libreria Visitor 5.1.0 più recente e segui le configurazioni riportate di seguito, durante l’inizializzazione dell’istanza Visitor:
