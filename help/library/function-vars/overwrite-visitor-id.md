---
description: Questa proprietà sovrascrive gli ID ECID e Analytics di un visitatore che naviga da un dominio a un altro. Per sovrascrivere un ID, devi possedere e aver implementato il Servizio ID visitatore su ciascun dominio. Questo codice non ti consente di sovrascrivere gli ID su domini che non controlli.
...
Questa proprietà sovrascrive gli ID ECID e Analytics di un visitatore che naviga da un dominio a un altro. Per sovrascrivere un ID, devi possedere e aver implementato il Servizio ID visitatore su ciascun dominio. Questo codice non ti consente di sovrascrivere gli ID su domini che non controlli.
...
Per tenere traccia dei visitatori del sito, il Servizio ID visitatore scrive un ECID (o MID) in un cookie del browser. La tabella seguente elenca e descrive i casi d’uso comuni in cui potresti voler sovrascrivere un MID esistente impostato dal servizio ID visitatore in un altro dominio.
